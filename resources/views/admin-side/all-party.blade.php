...
<div class="content-wrapper">
    ...
    <section class="content-header">
        ...
        <ol class="breadcrumb">
            ...
            <li class="active"> View Party List</li>
                    ...
                    <div class="box-header with-border">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-3">
                                ...
                                <h3 class="box-title"> View Party List</h3>
                            ...
                            <div class="col-md-3" style="text-align: right; padding-top:30px;">
                                ...
                                <div class="form-group no-print">
                                    ...
                                    <a onClick="window.print()" title="Print" class="hvr-grow"
                                        data-toggle="tooltip"><img class="marginRight20px"
                                            src="assets/dist/img/print.png"></a>

                                    <a href="{{url('add-party')}}" title="Add New Party" class="hvr-grow"
                                        data-toggle="tooltip"><img src="assets/dist/img/add.png"></a>
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="{{ url('update-party') }}" method="post" enctype="multipart/form-data">
                    @csrf
...
// Ajax Call for Edit
$('#showParty').on('click', '.btn-edit', function() {
    ...
    $.ajax({
        ...
        success: function(data) {
            ...
            $('input[name=party_name]').val(data[0].party_name);
...
$('#showParty').on('click', '.btn-delete', function() {
